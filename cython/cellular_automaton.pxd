...
cdef extern from "<CAM/cam_interface.hxx>" : 
  cdef cppclass CythonClassName C++ClassName : 
    ...
    bool place_particle(double _jump_parameter, vector[unsigned int] _shape, vector[unsigned int] _nx_base, int _position, vector[double] _face_charge, vector[double] _properties )
